<?php get_header(); ?>
	...
	<div class="row">
		...
		<form action="" class="">
					...
					<div class="col-md-3">
					    <input type="text" required class="form-control-vin form-vin" placeholder="No. Of Truck">
					</div>
					<div class="col-md-3">
					    <input type="date" required class="form-control-vin form-vin" placeholder="Schd. Date mm/dd/yy">
					</div>
